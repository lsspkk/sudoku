...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('test_number_reader_v2_target2.log'),
...
def test_number_reader():
    ...
    for png_file in sorted(test_dir.glob('*.png')):
        ...
        for i in range(9):
            for j in range(9):
                ...
                # Read number
                number, method, confidence = reader.read_number(cell)
    ...
    with open('test_results_v2_target2.json', 'w') as f:
        json.dump(results, f, indent=2)
    logging.info("Detailed results saved to test_results_v2_target2.json")
